...
// && 연산자를 이용한 조건부 렌더링 && 연산자의 경우 단락 평가(short-circuit)에 의해서 왼쪽 식이 true로 평가될 경우
// 오른쪽 식을 평가하고 해당 식의 결과값을 반환하므로 이러한 성질을 조건부 렌더링에 활용 가능 false일 경우 아무것도 실행하지 않고
// false 반환
...
const div2 = <div>
    ...
    {/* 만약 읽지 않은 메시지가 있다면 경고문을 출력*/}
    {
        ...
        <h2>You have {unreadMessages.length}
            unread messages.</h2>/* 이 코드가 실행이 된다. = 원하는 그림을 그리게 한다 */
    }
    {
